...
public class SimulatorMultiBit {
    private static final String BROKER_URL = "tcp://192.168.13.77:31525";
    private static final String TOPIC = "edgex/rule/device/onvif-camera/ruleSource/1649243541899694081";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                detectionResult.setScenes_id("1649243541899694081");
                detectionResult.setArea_id("1648604655321432065");
                ...
                for(int i=0;i<countsum;i++){
                    detectionResult.setPoint_id("1648632670474551297");
                    // long time =  Calendar.getInstance().getTimeInMillis() ;
                    List<DetectionRule> list = new ArrayList<DetectionRule>();
                    DetectionRule detectionRule1 = new DetectionRule("object1","1649225940393906178","穿工服",1);
